package com.codeinspring.Game.controller;

import com.codeinspring.Game.Utils.JwtUtil;
import com.codeinspring.Game.dao.models.AuthenticationRequest;
import com.codeinspring.Game.dao.models.AuthenticationResponse;
import com.codeinspring.Game.dao.models.Game;
import com.codeinspring.Game.services.GameService;
import com.codeinspring.Game.services.MyUserDetailsService;
...
public class GameController {
    ...
    public List<Game> getAllGameBySearchOrWithoutSearch(@RequestParam(required = false, name = "keyword") String keyword) {
        ...
        if (gameService.getListOrderById().size()==0) {
            String pathToFile = "/Users/subhamk/Downloads/Game/src/main/resources/game.csv";
